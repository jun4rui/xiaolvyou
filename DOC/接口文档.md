...
### 用户信息相关接口:
  获取用户信息接口
  http://localhost:8080/htonline-webroot/user/htuser_getGuestsInfoById.action?userid=609652
  choujiang
  获取用户账单choujiang
  http://localhost:8080/htonline-webroot/user/htuser_getTourOrderDetail.action?userid=609652